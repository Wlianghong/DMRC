...
# 日志文件目录和文件名
log_dir = "../logs"
file1 = "DMRCMLP-PEMS03-2025-01-17-06-33-30.log"  # DMRC
file2 = "DMRCMLP-PEMS03-2025-01-18-18-41-51.log"  # without reconstruction, and without masking
...
plt.savefig("case_study_pems03.svg", dpi=300, bbox_inches='tight')
plt.show()
