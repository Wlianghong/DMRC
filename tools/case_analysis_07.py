...
# 日志文件目录和文件名
log_dir = "../logs"
file1 = "DMRCMLP-PEMS07-2025-01-16-13-53-20.log"  # DMRC
file2 = "DMRCMLP-PEMS07-2025-01-20-16-34-26.log"  # without reconstruction, and without masking
...
plt.savefig("case_study_pems07.svg", dpi=300, bbox_inches='tight')
plt.show()
