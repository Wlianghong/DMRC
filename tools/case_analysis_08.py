...
# 日志文件目录和文件名
log_dir = "../logs"
file1 = "DMRCMLP-PEMS08-2025-01-16-13-53-18.log"  # DMRC
file2 = "DMRCMLP-PEMS08-2025-01-17-09-57-11.log"  # without reconstruction, and without masking
...
plt.savefig("case_study_pems08.svg", dpi=300, bbox_inches='tight')
plt.show()
